def test_criar_conta_nova_retorna_201(client):
    resp = client.post("/v1/internal/wallet/contas", json={"cpf": "11122233344"})
...
def test_criar_conta_com_cpf_repetido_e_idempotente(client):
    primeira = client.post("/v1/internal/wallet/contas", json={"cpf": "22233344455"})
    segunda = client.post("/v1/internal/wallet/contas", json={"cpf": "22233344455"})
...
def test_criar_conta_com_cpf_invalido_e_rejeitada(client):
    resp = client.post("/v1/internal/wallet/contas", json={"cpf": "123"})
